  ...
  test('resumes a task-linked gemini agent after app restart', async () => {
    ...
    try {
      ...
      try {
        ...
        await expect(window.locator('.task-node .agent-provider-icon')).toHaveAttribute(
          'data-agent-provider',
          'gemini',
        )
