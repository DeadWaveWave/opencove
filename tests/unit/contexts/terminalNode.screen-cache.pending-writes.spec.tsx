...
vi.mock(
  '../../../src/contexts/workspace/presentation/renderer/components/terminalNode/outputScheduler',
  async () => {
    const actual = await vi.importActual<
      typeof import('../../../src/contexts/workspace/presentation/renderer/components/terminalNode/outputScheduler')
    >(
      '../../../src/contexts/workspace/presentation/renderer/components/terminalNode/outputScheduler',
    )
    ...
    return {
      ...
      createTerminalOutputScheduler: () => ({
        ...
        onViewportInteractionActiveChange: () => undefined,
...
describe('TerminalNode screen cache with pending writes', () => {
  beforeEach(() => {
    ...
    serializeSpy.mockReturnValue('SCREEN_AFTER_HYDRATION')
  ...
  it('preserves the latest committed cache even when pending writes remain on unmount', async () => {
    ...
    dataListener?.({ sessionId: 'session-cache-pending', data: 'LIVE_FRAME' })
