...
### 🐞 Fixed
- Sidebar: use a continuous shared-list animation for expanded/collapsed mode switches, preserve list scroll position, add overflow edge fades, and keep label color context menus open for consecutive changes. (#292)
