...
### 💅 Changed
- Workspace canvas: note markdown export now saves directly to Downloads and reports completion through the app message toast instead of inline note status text. (#253)
