...
### 🚀 Added
- Workspace canvas: add full browser-window capability with client-local history, bookmarks, homepage, downloads, permissions, find, fullscreen, 90% sizing constraints, and WebUI iframe fallback. (#246)
