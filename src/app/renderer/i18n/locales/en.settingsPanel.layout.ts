export const enSettingsPanelLayout = {
  ...
  pageDescriptions: {
    ...
    worker: 'Configure Worker runtime, access, and remote machines.',
  ...
  workerConnections: {
    ...
    help: 'Remote machines and browser access live with Worker setup, so connection state is visible in one place.',
    endpointsDisabledHelp: 'Enable Remote machines before adding or managing them.',
    endpointsDisabledValue: 'Remote machines disabled',
  },
} as const
