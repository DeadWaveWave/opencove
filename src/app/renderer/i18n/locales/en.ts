export const en = {
  ...
  githubPullRequest: {
    title: 'Pull Request',
    tabs: 'Pull request tabs',
    overview: 'Overview',
    checks: 'Checks',
    diff: 'Diff',
    unavailable: 'GitHub integration unavailable',
    apiUnavailable: 'GitHub integration API is unavailable. Please restart OpenCove and try again.',
    createFromBranch: 'Create pull request for {{branch}}',
    ...
    close: 'Close',
    reopen: 'Reopen',
    confirmMerge: 'Merge this pull request?',
    confirmClose: 'Close this pull request?',
    comment: 'Comment',
    ...
    noPullRequest: 'No pull request found for this branch.',
    createTitle: 'Title',
    createBase: 'Base (optional)',
    createBasePlaceholder: 'e.g. main',
    createBody: 'Body (optional)',
