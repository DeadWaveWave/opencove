...
export const enSettingsPanel = {
  ...
  experimental: {
    ...
    workerWebUi: {
      ...
      enabledHelp:
        'Turns the Worker-hosted Web UI and debug shell on or off without restarting terminals.',
      portLabel: 'Port',
      portHelp:
        'Leave empty (or 0) to use a random port. A new listener is validated before the active port changes.',
      ...
      passwordHelpSet: 'Password is set. Changing it securely signs out existing Web sessions.',
