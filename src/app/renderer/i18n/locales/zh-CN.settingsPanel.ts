...
export const zhCNSettingsPanel = {
  ...
  quickMenu: {
    ...
    phrases: {
      ...
      createTitle: '创建快捷短语',
      editTitle: '编辑快捷短语',
      editorHelp: '短语会插入到光标位置，并替换当前选区。',
      titleLabel: '名称',
      titlePlaceholder: '为短语命名…',
      contentLabel: '内容',
      contentPlaceholder: '输入短语内容…',
      enabled: '启用',
    },
  },
  notifications: {
  ...
  canvas: {
    ...
    viewportTransitionLabel: '视口转移效果',
    viewportTransitionHelp: '选择窗口节点与 Space 之间的视口移动效果，遵循系统减少动态效果设置。',
    viewportTransition: { fly: '缩放飞行', slide: '平滑移动' },
  ...
  experimental: {
    ...
    workerWebUi: {
      ...
      enabledHelp: '开启或关闭本机 Worker 托管的 Web UI 与 Debug Shell，不会重启终端。',
      portLabel: '端口',
      portHelp: '留空（或 0）表示随机端口。新监听器验证成功后才会切换端口。',
      portPlaceholder: '随机',
      portSave: '应用',
      statusLabel: '状态',
      ...
      passwordHelpSet: '密码已设置。修改密码会安全退出已有 Web 会话。',
      ...
      errors: {
        ...
        applyFailed: '无法更新 Web 访问设置，原有监听器仍保持可用。',
        degraded: '恢复原有监听器期间无法接受新的 Web 访问；已升级的现有会话仍保持连接。',
        invalidConfig: 'Web 访问配置无效。',
      },
    },
