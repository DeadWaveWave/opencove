...
export const zhCN = {
  ...
  sidebar: {
    ...
    projectRoot: '项目根层',
    expandProjectTree: '展开项目',
    collapseProjectTree: '折叠项目',
    ...
    spaces_one: '{{count}} 个 Space',
    spaces_other: '{{count}} 个 Space',
  ...
  documentNode: {
    ...
    binaryReadUnavailable: '当前环境无法加载图片、音频或视频预览。',
    binaryTitle: '暂不支持预览此文件',
    binaryMessage: '可使用其他应用查看此文件。',
    previewUnavailableForType: '暂不支持预览 {{fileType}} 文件',
    imageTooLargeTitle: '图片过大',
    imageTooLargeMessage: '此图片超过 50 MiB 的预览大小限制。',
    tooLargeTitle: '文件过大',
    tooLargeMessage: '该文件过大，无法在画布编辑器中打开。',
    imageUnsupportedTitle: '图片预览失败',
    imageUnsupportedMessage: '无法预览此图片，文件可能已损坏或使用了不支持的格式。',
  ...
  terminalLink: {
    ...
    playVideo: '播放视频',
    openBrowser: '在浏览器中打开',
    openFinder: '在 Finder 中打开',
    openFolder: '打开文件夹',
    openExplorer: '在文件浏览器中打开',
    openWithDefaultApp: '使用默认应用打开',
    noDestination: '当前项目没有可浏览此来源的文件视图。',
    copy: '复制',
    resolving: '正在检查目标…',
    confirmDirectory: '此路径基于终端启动目录，请确认目标后打开。',
    notFound: '未找到目标。',
    forbidden: '目标超出允许访问的文件范围。',
    unavailable: '当前环境无法打开此目标。',
    openFailed: '未能打开此目标，请重试。',
  },
  terminalFind: {
    placeholder: '查找…',
    previous: '上一个匹配',
