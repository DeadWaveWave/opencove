...
export const zhCN = {
  ...
  githubPullRequest: {
    ...
    checks: 'Checks',
    diff: 'Diff',
    unavailable: 'GitHub 集成不可用',
    apiUnavailable: 'GitHub 集成 API 不可用，请重启 OpenCove 后重试。',
    createFromBranch: '为 {{branch}} 创建 PR',
    ...
    markReady: '转为 Ready',
    convertToDraft: '转为 Draft',
    merge: '合并',
    close: '关闭',
    reopen: '重新打开',
    confirmMerge: '确认合并此 PR？',
    confirmClose: '确认关闭此 PR？',
    comment: '评论',
    commentPlaceholder: '写点评论…',
    addComment: '添加评论',
    review: '评审',
    reviewPlaceholder: '写点评审意见…',
    approve: '通过',
    requestChanges: '请求修改',
    reviewComment: '评论',
    noPullRequest: '此分支暂无 PR。',
    createTitle: '标题',
    createBase: '目标分支（可选）',
    createBasePlaceholder: '例如 main',
    createBody: '说明（可选）',
    createBodyPlaceholder: '描述本次改动…',
    createDraft: '创建为 Draft',
    publishBranch: '发布分支',
    advanced: '高级选项',
    hideAdvanced: '收起高级选项',
    create: '创建 PR',
