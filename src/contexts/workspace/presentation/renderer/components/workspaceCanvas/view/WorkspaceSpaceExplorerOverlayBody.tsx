...
export function WorkspaceSpaceExplorerOverlayBody({
  spaceName,
  spaceId,
  rootUri,
  explorerClipboard,
  ...
  return (
    <>
      ...
      <WorkspaceSpaceExplorerOverlayWindows
        ...
        moveConfirmation={model.moveConfirmation}
        onCancelDelete={model.cancelDelete}
        onConfirmDelete={() => {
          void model.confirmDelete()
        }}
        onCancelMove={model.cancelMove}
        onConfirmMove={() => {
          void model.confirmMove()
        }}
      />
    </>
  )
