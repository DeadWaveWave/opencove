export const IPC_CHANNELS = {
  ...
  integrationGithubGetPullRequest: 'integration:github:get-pull-request',
  integrationGithubGetPullRequestChecks: 'integration:github:get-pull-request-checks',
  integrationGithubGetPullRequestDiff: 'integration:github:get-pull-request-diff',
  integrationGithubExecutePullRequestAction: 'integration:github:execute-pull-request-action',
  ptySpawn: 'pty:spawn',
