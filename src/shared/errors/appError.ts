...
function createMessageMap(): Record<AppErrorCode, string> {
  return {
    ...
    'issue_report.prepare_failed': 'Unable to prepare the issue report.',
    'issue_report.open_failed': 'Unable to open the issue report.',
    'issue_report.show_file_failed': 'Unable to show the issue report file.',
